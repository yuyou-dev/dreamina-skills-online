...
| `grill-me-jewelry` | [Grill-Me珠宝创作](projects/grill-me-jewelry/skill/Grill-Me珠宝创作.md) | 主石视觉分析、艺术设计访谈、纹样文化转译和 Seedream 5.0 Pro 标准白底候选生成 |
...
Grill-Me 的珠宝展示图反推、Seedream 5.0 Pro 实测与提示词结论记录在 [珠宝展示质量研究](projects/grill-me-jewelry/references/jewelry-display-quality-research.md)；形式构成、主石视觉母题、纹样文化转译、动态访谈和当代趋势记录在 [珠宝艺术设计与动态访谈研究](knowledge/research/jewelry-art-design-interview-research.md)。
